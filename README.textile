...
If set RSA public keys are used for logging in instead of plaintext password. This option takes a path to your RSA private key file. The path is relative to Textpattern installation location (e.g. @textpattern/@).

bc. ../../id_rsa

The above would used @id_rsa@ file placed to the directory located one level above your main @index.php@ file.
